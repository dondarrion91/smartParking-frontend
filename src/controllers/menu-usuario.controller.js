                            ...
                            .then((usuarioReserva) => {
                                ...
                                <div class="card bg-primary" >
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-success" ${lugar.estado === "DISPONIBLE" || lugar.estado === "PAGADO" ? "style='display:none;'" : ""} id='${
                                            lugar._id
                                        }'>${
                                    dataUsuario.admin
                                        ? "Cobrar Reserva"
                                        ...
                                        ${
                                            dataUsuario.admin
                                                ? `<button ${lugar.estado === "DISPONIBLE" || lugar.estado === "PAGADO" ? "style='display:none;'" : ""} class='btn btn-danger'>Borrar reserva</button>`
                                                : ""
                                        }  
                                    </div>
                                </div>
